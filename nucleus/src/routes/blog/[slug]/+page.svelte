...
<div
	class="fixed top-0 left-0 z-10 w-full bg-plum-950/90 px-4 py-2 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none"
>
	<a href="/" class="text-pale-2 transition-colors hover:text-plum-400"> ← home </a>
</div>
